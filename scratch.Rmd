...
yfin_url <- paste0("https://finance.yahoo.com/quote/",ticker,"/financials?p=",ticker)
  ...
  assign(paste0(ticker,"_income_raw"),df)
```
...
yfin_url <- paste0("https://finance.yahoo.com/quote/",ticker,"/financials?p=",ticker)
  ...
  df <- df %>% dplyr::filter(Breakdown != "Operating Expenses" & Breakdown != "Reported EPS"  & Breakdown != "Weighted average shares outstanding")
  
  assign(paste0(ticker,"_income_clean"),df)
...
yfin_url <- paste0("https://finance.yahoo.com/quote/",ticker,"/financials?p=",ticker)
  ...
  assign(paste0(ticker,"_income_tidy"),df)
